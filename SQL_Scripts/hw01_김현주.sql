...
create table world
	...
	area int, population int,
	capital varchar(30), top_level_domain varchar(3)
	);
...
insert into world (country, continent, area, population, capital, top_level_domain)
			values('New Zealand', 'Oceania', 270467, 4538520, 'Wellingtion', '.nz');
insert into world (country, continent, area, population, capital, top_level_domain)
...
# 유럽국가의 country, capital, top_level_domain 컬럼만 출력
select country, capital, top_level_domain from world where continent='Europe';

# 아시아국가들의 인구수 내림차순으로 country, population 컬럼을 출력
