...
def fruitPredict2(file):
    ...
    SAVE_PATH = r"C:\Users\kdp\KDT_06\KDT\EX_PY06\KDT\Project10\models\project" # 웹상에서는 절대경로만
    SAVE_MODEL = r"C:\Users\kdp\KDT_06\KDT\EX_PY06\KDT\KDT-1\Project10\cgi-bin\loss_0.083_score0.976.pth"
    target = ['Apple', 'Banana', 'Orange', 'Strawberry']
    ...
    file = r"C:\Users\kdp\Desktop\DATA\Project10\images\\" + file
...
result = fruitPredict2('apple01.jpg')
print(result)